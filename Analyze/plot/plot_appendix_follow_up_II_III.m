function plot_appendix_follow_up_II_III()

c_subject = [5004,5009,5007,5002];

%5003,5001,5008 in the main figure
...
m(1) = 0; %extra margin between measurements
for c_con = 2:n_contrast
        m(c_con) = mod(c_con,2) * 0.03 + m(c_con-1);
end
...
for c_con = 1:n_contrast
    ...
    elseif mod(c_con,2) == 0
        ...
        ax_l = m_left  + (c_con-1) * pw + m(c_con);
...
print(sprintf('Follow_up_II2III.png'),'-dpng','-r300')
